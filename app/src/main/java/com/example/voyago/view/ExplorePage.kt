...
@Composable
fun ExplorePage(navController: NavController,    tripRepo: TripRepository,
                userRepo: UserRepository,vm: TripViewModel = viewModel(
    factory = TripViewModelFactory(tripRepo, userRepo)
)) {
